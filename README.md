...
- **Punch-In/Out Switch**. Ограничить область записи (**Loop Switch** при этом должен быть выключен). Запись будет производиться только в ограниченную выделением область. Ограниченивать можно начало и/или конец участка
