...
- **Mute/Solo**. Заглушить дорожку / Заглушить все дорожки кроме выбранной

- **Volume**, **Panorama**. Уменьшить громкость дорожки, направить звук в правый или левый канал

- **Блок Send**. Направить сигнал на один из **Return**-дорожек
