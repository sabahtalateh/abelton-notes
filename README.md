...
Позволяет быстро открыть меню выбора входного звукового устройства
...
2. Выбрать на нём **Resampling** в качестве входного сигнала
...
Все варианты под **Resampling** это другие дорожки проекта, любую из них можно выбрать как источник и записать звук, выбрав в каком месте звук должен быть скопирован
