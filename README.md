...
- Масштабирование в выделенную область производится нажатием `Z` два раза, первое нажатие масштабирует по горизонтали, второе по вертикали. Чтобы вернуться к предыдущему масштабу можно нажать `H`, `W` или `X`
