...
Этот режим позволяет записать звук из **Master**-канала микшера, сигнал при этом не будет зацикливаться, так как **Abelton** не пропустит этот сигнал на микшер по второму кругу. В программе это видно по тому, что полоски уровня звука на **Resampling**-дорожке будут серого цвета
...
4. Записать звук
5. Теперь у нас есть дорожка, на которой записана сумма всех других дорожек. Наверное это зачем-то нужно :) ![image](./images/resampling.png)
