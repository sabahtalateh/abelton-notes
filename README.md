...
Предоставляют возможность скопировать сигнал с выбранной дорожки на **Return** канал, с целью добавления каких-то эффектов и последующей отправки обратно в микшер
