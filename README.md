...
## [Send/Return-каналы](https://youtu.be/cdcgVkYV0k4?si=juT5TGC2g6J5qin2&t=4158)

Это такие каналы на которые что-то посылается, они там применяют какие-то эффекты и отправляют то, что получилось в master канал, и там это всё сливается в один звук. Нужно при сведении звука
